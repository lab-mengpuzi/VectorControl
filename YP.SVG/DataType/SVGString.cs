...
namespace YP.SVG.DataType
{
	...
	public struct SVGString:Interface.DataType.ISVGString
	{
        ...
        public static bool operator ==(SVGString str1, SVGString str2)
        {
            return string.Compare(str1.valuestr, str2.valuestr) == 0;
        }
        ...
        {
            return this.valuestr?.GetHashCode() ?? 0;
        }
	}
}
